...
const sidebarLinks = [
  ...
  { icon: Calendar, label: "Workout Plans", path: "/dashboard/workouts" },
  { icon: Utensils, label: "Diet Plans", path: "/dashboard/diet" },
...
export default function UserLayout() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-black border-r border-green-500/20 transform transition-transform lg:static lg:translate-x-0",
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="h-16 bg-black border-b border-green-500/20 flex items-center justify-between px-4 lg:px-6">
          <button
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div
              className="w-10 h-10 rounded-full bg-green-500 text-black
        ...
        {/* Page Content */}
        <main className="flex-1 p-4 lg:p-6 bg-black overflow-auto">
          <Outlet />
        </main>
      </div>
    </div>
